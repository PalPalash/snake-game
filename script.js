const area_w = 640,
  area_h = 480,
  tile_sz = 32,
  area_tile_w = area_w / tile_sz,
  area_tile_h = area_h / tile_sz,
  padding = tile_sz / 4,
...
function end_game(e) {
  clearInterval(phys_timer), setTimeout(function() {
    alert(e)
  }, 250)
}
  ...
  if (!i) {
    for (var _ = 1; _ < pos.length; _++)
      if (pos_equal(pos[_], e)) {
        t = !0;
        break
      } t && (forgive ? end_game("Oops! You hit the wall or bumped into yourself!") : forgive = !0)
  }
  t || (i || pos.shift(), pos.push(e), i && (pos.length == max_snake ? (food = null, end_game("YOU'RE WINNER ! MY GOD YOU MADE IT TILL HERE!")) : place_food()), forgive = !1)
}
